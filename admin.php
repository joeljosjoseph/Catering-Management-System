        ...
        <div class="row no-gutters row-bordered row-border-light">
          <div class="col-md-2 pt-0">
            <div class="list-group list-group-flush account-settings-links">
              <a class="list-group-item list-group-item-action active" data-toggle="list"
                href="#admin-edit-food">Menu</a>
              <a class="list-group-item list-group-item-action" data-toggle="list" href="#admin-edit-users"
                onclick="">Users</a>
              <a class="list-group-item list-group-item-action" data-toggle="list" href="#cat-edit">Category</a>
          ...
          <div class="col-md">
            <div class="tab-content">
              ...
              <div class="tab-pane fade active show" id="admin-edit-food">
                ...
                <div class="card-body ">
                  ...
                  <?php
                    ...
                    if( isset( $_SESSION['subcatact']) )
                    {
                      ?>
                  <div class="alert alert-success alert-custom" role="alert" style="text-align: center;width: 80%;">
                    <?php echo  $_SESSION['subcatact'];?>
                  </div>
                  <?php
                            unset( $_SESSION['subcatact']);
                    
                    }

                    if( isset( $_SESSION['subcatdeact']) )
                    {
                      ?>
                  <div class="alert alert-success alert-custom" role="alert" style="text-align: center;width: 80%;">
                    <?php echo  $_SESSION['subcatdeact'];?>
                  </div>
                  <?php
                            unset( $_SESSION['subcatdeact']);
                    
                    }

                    if( isset( $_SESSION['subcatadded']) )
                    {
                      ?>
                  <div class="alert alert-success alert-custom" role="alert" style="text-align: center;width: 80%;">
                    <?php echo  $_SESSION['subcatadded'];?>
                  </div>
                  <?php
                            unset( $_SESSION['subcatadded']);
                    
                    }

                    if( isset( $_SESSION['subcatexists']) )
                    {
                      ?>
                  <div class="alert alert-danger alert-custom" role="alert" style="text-align: center;width: 80%;">
                    <?php echo  $_SESSION['subcatexists'];?>
                  </div>
                  <?php
                            unset( $_SESSION['subcatexists']);
                  ...
                  <div class="modal fade .bd-example-modal-lg" id="addFoodModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <form action="php/admin_item_add.php" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="recipient-name" name="item_name" required>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <textarea class="form-control" id="message-text" style="height: 200px;" name="description"
                                required></textarea>
                            </div>
                            ...
                            <div>
                              ...
                              <input type="file" id="img" name="img" accept=".jpg, .png, .jpeg" required>
                            </div>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn"
                              style="border: 2px solid cornflowerblue;color:cornflowerblue;">Add Item</button>
                          </div>
                        </form>
                      </div>
                    </div>
                  ...
                  <div id="admin-menu-card">
                    ...
                    <div style="width: 100%;margin-bottom: 20px; display:flex" id="addFoodPlus">
                      <div>
                        <a data-target="#addFoodModal" data-toggle="modal">
                          <svg xmlns="http://www.w3.org/2000/svg" id="addFoodPlusIcon" width="50px" height="50px"
                      ...
                      <div>
                        <p style="font-size: large;font-weight: 600;margin: 60px 0 0 30px  ;">Add New Food</p>
                      </div>
                    </div>
                    ...
                    <?php   // LOOP TILL END OF DATA 
                          ...
                          $result1=mysqli_query($conn,$sql_fetch1);
                           ...
                           { 
                             ...
                             $sql_fetch2 = "SELECT * FROM sub_category WHERE category_id = '$categ_id'";
                    ...
                    <div style="width: 100%;">
                      ...
                      <?php
                            $subcatcount= 0;
                             ...
                             {
                               $subcateg_id = $row2['subcategory_id'];
                               $sql_fetch3 = "SELECT * FROM item WHERE subcategory_id = '$subcateg_id'";
                      ...
                      <div style="width: 100%;display: flex;">
                        ...
                        <?php
                            $itemcount = 0;
                              ...
                              { 
                                if($row3['subcategory_id'] == $row2['subcategory_id'] && $row3['item_status'] == 'Active')
                                {
                                  $itemcount = 1;
                        ...
                        <a href="admin_item.php?item_id=<?php echo $row3['item_id'];?>"
                          style="text-decoration: none;color: inherit;">
                          <div class="card " id="admin-menu-card-body-active"
                            style="height: 220px;width: 200px; margin-left: 20px;">
                            <img class="card-img-top"
                              src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row3['item_image']); ?>"
                              alt="Card image cap" style="height: 160px;width: 200px;">
                      ...
                      else if($row3['subcategory_id'] == $row2['subcategory_id'] && $row3['item_status'] == 'InActive')
                        {
                          $itemcount = 1;
                        ...
                        <a href="admin_item.php?item_id=<?php echo $row3['item_id']; ?>"
                          style="text-decoration: none;color: inherit;">
                          <div class="card " id="admin-menu-card-body-inactive"
                            style="height: 220px;width: 200px; margin-left: 20px;">
                            <img class="card-img-top"
                              src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row3['item_image']); ?>"
                              alt="Card image cap" style="height: 160px;width: 200px;">
                    ...
                    {
                      ?>
                        <p style="font-size:15px;color:red">No Food Items Present</p>
                        <?php }
                      ?>
                      </div>
                      <?php
                  ...
                  if($subcatcount == 0) {
                    ?>
                      <p style="font-size:15px;color: red;">No subcategory Inserted</p>
                      <?php
                  }
                  ?>
                    </div>
              ...
              <!-- Category Info -->
              <div class="tab-pane fade" id="cat-edit">
                <hr class="border-light m-0">
                <div class="card-body pb-2" style="padding-left: 70px;">
                    ...
                    require_once('php/connection.php');
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="admin_subcat.php?cat_id=<?php echo $rows['category_id']; ?>" class="btn"
                              style="border: 1px solid black;">View</a>
                          </td>
                          <?php }
                              ?>
                      </tbody>
