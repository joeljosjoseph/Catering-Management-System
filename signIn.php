...
<html lang="en">
  ...
  <head>
    ...
    <title>Catering Management | Sign In</title>
...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light " style="flex-direction: column;display: flex; ">
    ...
    <!-- division 1 -->
            ...
            <!-- Logo -->
              ...
              <div style="margin:auto">
                ...
                <form class="d-flex input-group" style="width:900px;height: 30px;"  method="POST" action="search.php">
                  <input class="form-control" style="font-size: small;border-right:white" name="search" id="admin-item-input" autocomplete="off" type="Search" placeholder="Search " aria-label="Search">
                  <button class="input-group-text" style="background-color: white;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
      ...
      <div class="container d-flex justify-content-center " style="height: 450px;">
      <?php
          if( isset($_SESSION['nouser'] ) )
          {
              ?>
              <div class="alert alert-danger alert-custom" role="alert" style="width: 75%;" style="border: 3px solid red;">
        ...
        <div class="col-md-7 col-lg-6 ml-auto">
            <form action='php/signin_action.php' method='POST'>
                <div class="row d-flex justify-content-center">
                    ...
                    <input id="password" type="password" name="password" required placeholder="Password" class="form-control bg-white border-left-0 border-md">
                    </div>

                    <!-- Submit Button -->
                    <div class="form-group col-lg-12 mx-auto mb-0 d-flex justify-content-center">
                        <button href="#" class="btn btn-secondary btn-block py-2" type="submit">
                    ...
                    <div class="text-center w-100">
                        <p class="text-muted font-weight-bold">Don't have an account? <a href="signUp.php" class="text-primary ml-2">Sign Up</a></p>
                    </div>
                </div>
            </form>
        </div>
